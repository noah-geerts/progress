        ...
        seededSets = List
                .of(
                        ...
                        PerformedSet.builder().reps(5).weight(225.0).performedExercise(seededPEs.get(0)).uid(TEST_UID)
                                ...
                                .build(),
                        // Bench 220x4
                        PerformedSet.builder().reps(4).weight(220.0).performedExercise(seededPEs.get(0)).position(2)
                                .uid(TEST_UID)
                                .build(),
                        // Dumbell Press 60sx12
                        PerformedSet.builder().reps(12).weight(60.0).performedExercise(seededPEs.get(1)).position(1)
                                .uid(TEST_UID)
                                .build(),
                        // Squat 315x3
                        PerformedSet.builder().reps(3).weight(315.0).performedExercise(seededPEs.get(2)).position(2)
                                .uid(TEST_UID)
                                .build(),
                        // Squat 315x2
                        PerformedSet.builder().reps(2).weight(315.0).performedExercise(seededPEs.get(2)).position(1)
                                .uid(TEST_UID)
                                .build());
    ...
    class GetSession {
        ...
        void shouldReturnCorrectChestDayWorkout_WhenGettingChestDay() throws Exception {
            ...
            mockMvc.perform(get("/sessions/2025-01-01")
                    ...
                    .andExpect(jsonPath("$.performedExercises[0].exercise.name").value("Dumbell Press"))
                    .andExpect(jsonPath("$.performedExercises[0].sets", hasSize(1))) // 1 dumbell press set
                    ...
                    .andExpect(jsonPath("$.performedExercises[1].exercise.name").value("Bench Press"))
                    .andExpect(jsonPath("$.performedExercises[1].sets", hasSize(2))) // 2 bench press sets
